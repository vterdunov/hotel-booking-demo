...
- ✅ Сортировка доступных номеров по возрастанию times_booked

### Согласованность данных между сервисами
- ✅ Сага с компенсацией (подтверждение/откат)
- ✅ Устойчивость вызовов (Retry/Timeout на взаимодействии с Hotel Service)
- ✅ Двухшаговое подтверждение: PENDING→CONFIRMED
- ✅ При сбое — статус CANCELLED с компенсацией

### Booking Service
- ✅ CRUD бронирований
- ✅ Идемпотентность запросов (requestId)
- ✅ Пагинация истории бронирований
- ✅ Валидация дат
- ✅ Проверка прав доступа (только свои бронирования)

### Hotel Service
- ✅ CRUD отелей и номеров
- ✅ Статистика загруженности номеров
- ✅ Фильтрация доступных номеров по датам
- ✅ Рекомендация номеров

### Gateway + Eureka
- ✅ Маршрутизация через API Gateway
- ✅ Интеграция с Eureka для динамического обнаружения сервисов
...
- ✅ JWT аутентификация
- ✅ Роли USER/ADMIN
- ✅ Методная безопасность (@PreAuthorize)
- ✅ Корректные статусы ошибок (401/403)
...
- ✅ Негативные кейсы (ошибки авторизации/валидации)

### Структура баз данных
- ✅ Корректная схема с необходимыми таблицами
...
- ✅ Корреляция запросов (traceId, requestId)
